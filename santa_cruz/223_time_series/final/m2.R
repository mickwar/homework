...
#    Gj(1, 12), Gj(2, 12), Gj(3, 12), Gj(4, 12), Gj(5, 12), -1))
...
pdf("./figs/m2_discount.pdf", height = 8, width = 8)
...
text(d.max+0.02, max(opd) + 1.0, round(max(opd), 2), cex = 2)
dev.off()
...
pdf("./figs/m2_components.pdf", width = 12, height = 16)
...
for (i in 1:3){
    ...
    plot(0, bty='n', type='n', xlim = c(1,n), ylim = c(-20, 20),
        xlab = "Time", ylab = "Search interest", cex.lab = 1.4, cex.main = 2,
        axes = FALSE, main = paste("Harmonic", j))
    axis(2)
    axis(1, at = x.ind, labels = times[x.ind])
    center = out$mt[,2*i+1]
...
## One-step ahead
pdf("./figs/m2_onestep.pdf", width = 12, height = 8)
par(mfrow = c(1,1), mar = c(5.1, 4.1, 4.1, 2.1))
plot(y, bty='n', type='o', ylim = c(0, 120), col = 'gray50',
    xlab = "Time", ylab = "Search interest", cex.lab = 1.4, cex.main = 2,
...
pdf("./figs/m2_smooth_components.pdf", width = 12, height = 16)
par(mfrow = c(3,2), mar = c(5.1, 4.1, 4.1, 2.1))
plot(y, bty='n', type='o', ylim = c(0, 120), col = 'gray50',
    xlab = "Time", ylab = "Search interest", cex.lab = 1.4, cex.main = 2,
    axes = FALSE, main = "Trend")
...
## 5-year forecast
pdf("./figs/m2_forecast.pdf", width = 12, height = 8)
par(mfrow = c(1,1), mar = c(5.1, 4.1, 4.1, 2.1))
