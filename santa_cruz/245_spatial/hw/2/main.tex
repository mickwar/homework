...
% \[ \int\psi_j(s)\overline{\psi_j(s)}dx = \delta_{jk} \]
% and
...
% 
% \begin{align*}
% \psi_i(s) = \begin{cases} \frac{\cos(v_js)}{\sqrt{L+\sin(2w_{j1}L)/(2w_{j1})}},~~~~~i=2j+1 \\
%  \frac{\sin(w_js)}{\sqrt{L-\sin(2w_{j2}L)/(2w_{j2})}},~~~~~i=2k \\
% \end{cases} \\
% \end{align*}
% 
% 
